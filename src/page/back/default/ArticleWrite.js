...
class ArticleWrite extends PageComponent {
    ...
    render(){
        ...
        const { article,  article_html, editor_type, saving } = this.state;
        ...
        switch(editor_type){
            ...
            case 1:
                editor =
                    <div className="edit-area">
                        <div ref="editorResult" className="result-html"  style={{width: '100%'}}  dangerouslySetInnerHTML={{
                            __html: article_html
                        }} />
                    </div>;
                break;
            case 2:
                editor =
                    <div className="edit-area">
                        ...
                        <div ref="editorResult" onScroll={this.resultOnScroll}  className="result-html" dangerouslySetInnerHTML={{
                            __html: article_html
                        }} />
                    </div>;
                break;
